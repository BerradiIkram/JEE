    ...
    CommandLineRunner start(EtudiantRepository etudiantRepository){
        return args -> {
            etudiantRepository.save(
                    new Etudiant(null, "berradi","ikram","ikram@gmail.com", Date.valueOf("2000-01-27"),true, Genre.FEMININ ));
            etudiantRepository.save(
                    new Etudiant(null, "badaoui","sara","sara@gmail.com", Date.valueOf("2001-02-07"),false, Genre.FEMININ));
            etudiantRepository.save(
                    new Etudiant(null, "alami","salma","salma@gmail.com", Date.valueOf("2000-04-20"), true,  Genre.MASCULIN));
            etudiantRepository.save(
                    new Etudiant(null, "alaoui","Mohammed","mohammed@gmail.com", Date.valueOf("2000-01-22"),true, Genre.MASCULIN));
   ...
   // @Bean
    CommandLineRunner saveUsers(ISecurityService iSecurityService){
        return args -> {
            ...
            iSecurityService.saveNewUser("sara","1234","1234");
            ...
            iSecurityService.addRoleToUser("sara","USER");
